...
ALTER TABLE recipe_ingredient
    ADD CONSTRAINT FK_RECIPEINGREDIENT_ON_RECIPE FOREIGN KEY (recipe_id) REFERENCES recipe
        (id);
...
ALTER TABLE shopping_item
    ADD CONSTRAINT FK_SHOPPINGITEM_ON_SHOPPINGLIST FOREIGN KEY (shopping_list_id) REFERENCES shopping_list (id);

ALTER TABLE shopping_list
    ADD CONSTRAINT FK_SHOPPINGLIST_ON_USER FOREIGN KEY (user_id) REFERENCES "user" (id);

ALTER TABLE user_allergen
    ADD CONSTRAINT FK_USERALLERGEN_ON_ALLERGEN FOREIGN KEY (allergen_id) REFERENCES allergen (id);

ALTER TABLE user_allergen
    ADD CONSTRAINT FK_USERALLERGEN_ON_USER FOREIGN KEY (user_id) REFERENCES "user" (id);

ALTER TABLE user_recipe
    ADD CONSTRAINT FK_USERRECIPE_ON_RECIPE FOREIGN KEY (recipe_id) REFERENCES recipe (id);

ALTER TABLE user_recipe
    ADD CONSTRAINT FK_USERRECIPE_ON_USER FOREIGN KEY (user_id) REFERENCES "user" (id);