...
CREATE SEQUENCE IF NOT EXISTS appuser_seq START WITH 1 INCREMENT BY 50;
...
ALTER TABLE shopping_list
    ADD CONSTRAINT FK_SHOPPINGLIST_ON_USER FOREIGN KEY (user_id) REFERENCES appuser (id);

ALTER TABLE user_allergen
    ADD CONSTRAINT FK_USERALLERGEN_ON_ALLERGEN FOREIGN KEY (allergen_id) REFERENCES allergen (id);

ALTER TABLE user_allergen
    ADD CONSTRAINT FK_USERALLERGEN_ON_USER FOREIGN KEY (user_id) REFERENCES appuser (id);

ALTER TABLE user_recipe
    ADD CONSTRAINT FK_USERRECIPE_ON_RECIPE FOREIGN KEY (recipe_id) REFERENCES recipe (id);

ALTER TABLE user_recipe
    ADD CONSTRAINT FK_USERRECIPE_ON_USER FOREIGN KEY (user_id) REFERENCES appuser (id);